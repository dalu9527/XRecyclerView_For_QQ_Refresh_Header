...
import com.xlibs.xrv.listener.OnRefreshCompleteListenter;
import com.xlibs.xrv.listener.OnRefreshDistanceListener;
...
public class XRecyclerView extends RecyclerView implements Runnable {
    ...
    private OnRefreshDistanceListener mOnRefreshDistanceListener;
    private OnRefreshCompleteListenter mOnRefreshCompleteListenter;
    ...
    public void setOnRefreshDistanceListener(OnRefreshDistanceListener onRefreshDistanceListener) {
        mOnRefreshDistanceListener = onRefreshDistanceListener;
    }

    /**
     * set RefreshComplete Listenter
     */
    public void setOnRefreshCompleteListenter(OnRefreshCompleteListenter onRefreshCompleteListenter) {
        mOnRefreshCompleteListenter = onRefreshCompleteListenter;
    }
    ...
    private void startAnimator(final View view, int start, int end) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (mHeaderViewHeight > (int) animation.getAnimatedValue()) {
                    mOnRefreshDistanceListener.refreshDistance((int) animation.getAnimatedValue());
                }
                view.requestLayout();
            }
        });
    ...
    private OnScrollByListener mOnScrollListener = new OnScrollByListener() {
        ...
        public void overScrollBy(int dy) {
            ...
            if (isEnable && !isLoadingData && isTouching
                ...
                mOnRefreshDistanceListener.refreshDistance(dy);
            }
